...
\begin{frame}{Indoor Positioning: Problem \& Approaches}
  \textbf{The Challenge:}
  \begin{itemize}
    \item GPS fails indoors (signal attenuation from building materials)
    \item Need alternative solutions for multi-floor environments
  \end{itemize}
  ...
  \begin{itemize}
    \item Minimal building knowledge required (no blueprints, no signal modeling)
    \item No signal processing or RSSI boosting infrastructure needed
    \item Learn patterns directly from raw RSSI fingerprints
  \end{itemize}

  \begin{alertblock}{Research Question}
    How to optimize grid size and feature selection for ML-based IPS?
  \end{alertblock}
\end{frame}

\begin{frame}{Research Contributions}
  \textbf{Gap:} Limited understanding of grid size and feature selection impact
