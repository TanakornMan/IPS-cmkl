...
\begin{frame}[plain,noframenumbering]
  ...
  \begin{tikzpicture}[remember picture,overlay]
    % White box that starts from near the left edge and goes to the right
    \fill[white] ([xshift=1cm]current page.north west) rectangle ([yshift=-1.8cm]current page.north east);
    % Yellow border around the white box
    \draw[line width=2pt,color=mLightBrown] ([xshift=1cm]current page.north west) rectangle ([yshift=-1.8cm]current page.north east);
    \node[yshift=-0.9cm] at (current page.north) {
      ...
      \hspace{1.5cm}
      \includegraphics[height=1cm]{logo/cmkl_logo.png}
    };
  \end{tikzpicture}
  \vspace{2.5cm}
  \titlepage
