...
\begin{document}
	...
	\begin{figure*}
		\includegraphics[width=\textwidth,height=4cm]{meth1.png}
	...
	To mitigate this issue and prevent the feature space from becoming overly complex, we applied a filtering criterion that retained only access points associated with the campus network. This ensured that the resulting dataset focused on relevant features while maintaining consistency across grids.
	...
	\begin{table}[htbp]
		...
		\multicolumn{1}{|l|}{\textbf{1x1 Grid Size}} & \multicolumn{1}{l|}{6}   & \multicolumn{1}{l|}{7}   &  &  \\ \cline{1-3}
